package com.elite.reflection.proxy;
...
import com.elite.reflection.EliteReflectionInterfaceInfo;
import com.elite.reflection.annotation.BConstructor;
import com.elite.reflection.annotation.BConstructorNotProcess;
import com.elite.reflection.annotation.BFieldCheckNotProcess;
import com.elite.reflection.annotation.BFieldNotProcess;
import com.elite.reflection.annotation.BFieldSetNotProcess;
import com.elite.reflection.annotation.BMethodCheckNotProcess;
import com.elite.reflection.annotation.BParamClass;
import com.elite.reflection.annotation.BClassNameNotProcess;
 ...
 * 此处无Bug
 */
public class EliteReflectionInterfaceProxy {

    private final List<EliteReflectionInterfaceInfo> mReflections = new ArrayList<>();
    ...
    public EliteReflectionInterfaceProxy(String packageName, String className, String origClassName) {
    ...
    public JavaFile generateInterfaceCode() {
        ...
        for (EliteReflectionInterfaceInfo reflection : mReflections) {
    ...
    private MethodSpec generateFieldSet(EliteReflectionInterfaceInfo reflection) {
    ...
    private MethodSpec generateFieldCheck(EliteReflectionInterfaceInfo reflection) {
    ...
    private MethodSpec generateMethodCheck(EliteReflectionInterfaceInfo reflection, List<ParameterSpec> parameterSpecs) {
        MethodSpec.Builder method = MethodSpec.methodBuilder("_check_" + reflection.getExecutableElement().getSimpleName().toString())
                .addModifiers(Modifier.PUBLIC, Modifier.ABSTRACT)
    ...
    public void add(EliteReflectionInterfaceInfo interfaceInfo) {
