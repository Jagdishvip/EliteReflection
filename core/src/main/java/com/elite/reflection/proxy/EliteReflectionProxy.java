...
import com.elite.reflection.EliteReflectionInfo;
import com.elite.reflection.utils.ClassUtils;
 ...
 * 此处无Bug
 */
public class EliteReflectionProxy {

    private static final ClassName BR = ClassName.get("com.elite.reflection", "EliteReflection");
    private final EliteReflectionInfo mReflection;

    private final ClassName mContextInterface;
    private final ClassName mStaticInterface;
    private final String mPackageName;

    public EliteReflectionProxy(String packageName, EliteReflectionInfo reflection) {
    ...
    private MethodSpec generaIsLoadMethod() {
        ...
        String statement = "return com.elite.reflection.utils.ClassUtil.classReady($T.class)";
        builder.addStatement(statement,
                mContextInterface
        );
        return builder.build();
