...
import com.elite.reflection.utils.Reflector;
...
//    }
            ...
            Object o = Proxy.newProxyInstance(clazz.getClassLoader(), new Class[]{clazz}, new InvocationHandler() {
                ...
                public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
                    ...
                    try {
                        ...
                        if (throwable instanceof EliteNullPointerException) {
    ...
    private static Object generateNullValue(Class<?> returnType) {
        ...
        if (returnType.isPrimitive()) {
            throw new EliteNullPointerException("value is null!");
        }
        return null;
    }
}
